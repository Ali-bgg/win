...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light ">
    <div class="col-md-6 mx-auto  ">
        <img src="images/tvtc.jpg" alt="">
      <h1 class="display-4 fw-normal">إربح مع علي</h1>
  ...
  <li class="list-group-item">سأقوم ببث مباشر لمدة ساعة عبارة عن سؤال و جواب</li>
...
<form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
 ...
 <h3>الرجاء ادخل معلوماتك</h3>
  ...
  <div class="mb-3">
    ...
    <input type="text" name="firstName"  id="firstName" class="form-control" value="<?php if(!empty($firstName)) echo $firstName ?>">
    <div  class="form-text error"> <?php echo $errors['firstNameError'] ?> </div>
  </div>

  <div class="mb-3">
    <label for="lastName" class="form-label">الاسم الأخير</label>
    <input type="text" name="lastName" id="lastName" class="form-control"  value="<?php if(!empty($lastName)) echo $lastName ?>">
